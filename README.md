...
[![Build Status]](https://github.com/3MFConsortium/lib3mf/workflows/Build/badge.svg?branch=release%2F2.4.1-alpha)
[![Documentation Status](https://readthedocs.org/projects/lib3mf/badge/?version=master)](https://readthedocs.org/projects/lib3mf)
[![Version 2.4.1-alpha](https://img.shields.io/static/v1.svg?label=lib3mf&message=v2.4.1-alpha&color=green)]()
