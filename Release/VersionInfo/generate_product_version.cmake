...
function(generate_product_version outfiles)
    ...
    if (NOT PRODUCT_PRODUCT_VERSION_MAJOR OR "${PRODUCT_PRODUCT_VERSION_MAJOR}" STREQUAL "")
        set(PRODUCT_PRODUCT_VERSION_MAJOR 1)
    endif()
    if (NOT PRODUCT_PRODUCT_VERSION_MINOR OR "${PRODUCT_PRODUCT_VERSION_MINOR}" STREQUAL "")
        set(PRODUCT_PRODUCT_VERSION_MINOR 0)
    endif()
    if (NOT PRODUCT_PRODUCT_VERSION_PATCH OR "${PRODUCT_PRODUCT_VERSION_PATCH}" STREQUAL "")
        set(PRODUCT_PRODUCT_VERSION_PATCH 0)
    endif()
    if (NOT PRODUCT_PRODUCT_VERSION_REVISION OR "${PRODUCT_PRODUCT_VERSION_REVISION}" STREQUAL "")
        set(PRODUCT_PRODUCT_VERSION_REVISION 0)
    endif()
