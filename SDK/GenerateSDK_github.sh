...
cp -r Autogenerated/Bindings $SDKARTIFACT
...
cp $LOCATION/lib3mf.dylib/lib3mf.${LIB3MF_VERSION_WITH_MODIFIED_PRE_RELEASE}.dylib $SDKARTIFACT/Bin/lib3mf.dylib || failed "Error copying binary"
