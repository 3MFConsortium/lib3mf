...
namespace NMR {
	...
	void CModelReaderNode_Boolean2307_BooleanShape::OnNSAttribute(_In_z_ const nfChar * pAttributeName, _In_z_ const nfChar * pAttributeValue, _In_z_ const nfChar * pNameSpace)
	{
